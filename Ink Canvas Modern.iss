...
#define OutputBaseFilename "Ink.Canvas.Modern.V" + MyAppVersion + ".Setup"
OutputBaseFilename={#OutputBaseFilename}
SetupIconFile="Ink Canvas\Resources\Brand\Ink Canvas Modern.ico"
Compression=lzma
