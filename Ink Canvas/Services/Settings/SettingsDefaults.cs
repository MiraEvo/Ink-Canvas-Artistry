namespace Ink_Canvas.Services.Settings
{
    ...
    {
        public static SettingsModel CreateRecommended(SettingsModel? currentSettings = null)
        {
            SettingsModel current = Normalize(currentSettings ?? new SettingsModel());
        ...
        public static SettingsModel Normalize(SettingsModel settings)
        {
