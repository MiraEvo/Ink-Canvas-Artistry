...
namespace Ink_Canvas
{
    public partial class MainWindow : Window
    {
        ...
        private void SetBoardTheme()
        {
            ...
            var lightBoardUri = new Uri("Resources/Styles/Board/Light-Board.xaml", UriKind.Relative);
            var darkBoardUri = new Uri("Resources/Styles/Board/Dark-Board.xaml", UriKind.Relative);
        ...
        private void SetTheme(string theme)
        {
            ...
            var lightUri = new Uri("Resources/Styles/App/Light.xaml", UriKind.Relative);
            var darkUri = new Uri("Resources/Styles/App/Dark.xaml", UriKind.Relative);
